...
pub(crate) mod rbac;
mod reverse_connect;
/// Security check registry — bounded audit trail of security-relevant events.
...
pub mod constants {
    ...
    pub const MAX_SUBSCRIPTIONS_PER_CALL: usize = 100;
    ...
    pub const MAX_SUBSCRIPTIONS_PER_SESSION: usize = 200;
    /// Maximum number of pending publish requests per session before further requests are rejected.
    pub const MAX_PENDING_PUBLISH_REQUESTS: usize = 200;
    ...
    pub const MAX_QUEUED_NOTIFICATIONS: usize = 10000;
