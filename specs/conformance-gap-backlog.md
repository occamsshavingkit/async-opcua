...
- **Live third-party PubSub CTR interop**: AES-CTR PubSub message security has been verified with spec-anchored KAT vectors and an independent-implementation interop cross-check; live interop with the OPC Foundation .NET or open62541 PubSub-CTR stacks is not runnable in CI and remains a future verification task.
