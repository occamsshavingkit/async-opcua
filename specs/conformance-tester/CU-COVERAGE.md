...
| 3207 | Base Info OptionSet DataType | implemented | OptionSet DataType present in schemas/1.05/Opc.Ua.NodeSet2.xml; exposed via CoreNamespace import. |
| 3210 | Base Info FileType Write | partial | fota/file_node.rs:207-229 creates a "Write" Method node (metadata only) via insert_method; no add_method_cb wiring found — no functional write semantics. |
...
| 3213 | Base Info FileType Base | partial | Session-bound FileType node structure created + tested fota/file_node.rs:120 & tests/fota_integration.rs:41-80, but Open/Read/Write/Close have no callback logic (no add_method_cb found) — non-functional I/O. |
| 3214 | Base Info Range DataType | implemented | Range in nodeset + generated types/range.rs; used as EURange in datachange_overflow.rs, alarms.rs. |
