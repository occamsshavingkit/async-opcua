...
static AUDIT_TABLE: &[(u32, EvidenceStatus, &str)] = &[
    ...
    (5522, EvidenceStatus::Implemented, "SuppressedState.TransitionTime written by set_suppressed (state_machine.rs); covered indirectly, no dedicated test yet (095 US1)"),
    ...
    (5525, EvidenceStatus::Implemented, "OutOfServiceState.TransitionTime written by set_out_of_service (state_machine.rs); covered indirectly, no dedicated test yet (095 US1)"),
