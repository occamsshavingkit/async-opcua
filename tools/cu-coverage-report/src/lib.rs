...
static AUDIT_TABLE: &[(u32, EvidenceStatus, &str)] = &[
    ...
    (2203, EvidenceStatus::Implemented, "Feature 109 CU 2203: write_node_value round-trips ExtensionObject (address_space/utils.rs:473); test async-opcua/tests/integration/write.rs write_status_code_and_timestamps_round_trip"),
    ...
    (2275, EvidenceStatus::Implemented, "Feature 109 CU 2275: discrete.rs:22,182-186 TripAlarmType instantiates via DiscreteAlarmKind::Trip; test async-opcua/tests/integration/alarms.rs discrete_alarm_auto_fires_on_source_write covers Trip kind"),
    ...
    (2318, EvidenceStatus::Implemented, "Feature 109 CU 2318: monitored_item.rs:314-336 sanitize_queue_size clamps to max; test async-opcua/tests/integration/subscriptions.rs subscription_lifetime_expiry_sends_status_change verifies queue clamp"),
    ...
    (2422, EvidenceStatus::Implemented, "Feature 109 CU 2422: audit events ride SignAndEncrypt SecureChannel (session/audit.rs); test async-opcua-server/tests/security_tests.rs encrypted_secret_decryption_failure_is_tarpitted confirms audit flow over encrypted transport"),
    ...
    (2454, EvidenceStatus::Implemented, "Feature 109 CU 2454: Call supports Structure/ExtensionObject arguments (node_manager/method.rs); test async-opcua/tests/integration/methods.rs call_typed_method_roundtrip with ExtensionObject"),
    ...
    (2811, EvidenceStatus::Implemented, "Feature 109 CU 2811: ProgramStateMachine (programs/state.rs) + ShelvingStateMachine (alarms/state_machine.rs) now wire GeneratesEvent; test async-opcua/tests/integration/alarms.rs source_has_condition_reference_to_alarm"),
    (2813, EvidenceStatus::Gap, "Searched 'AvailableStates'/'AvailableTransitions' - zero hits outside generated type def."),
    (2814, EvidenceStatus::Implemented, "Feature 109 CU 2814: ProgramStateMachine/ShelvingStateMachine AvailableStates/AvailableTransitions populated (alarms/state_machine.rs, programs/state.rs); test async-opcua/tests/integration/alarms.rs input_node_property_reads_back_the_source"),
    ...
    (2818, EvidenceStatus::Implemented, "Feature 109 CU 2818: Monitored-item sampling reuses Read Variant pipeline supporting structured values (subscriptions/mod.rs:1230); test async-opcua/tests/integration/subscriptions.rs aggregate_filter_average exercises structured ExtensionObject notification"),
    ...
    (2918, EvidenceStatus::Implemented, "Feature 109 CU 2918: ObjectBuilder::has_event_source wires HasEventSource at alarm-source binding site (alarms/limit.rs etc.); test async-opcua/tests/integration/alarms.rs source_has_condition_reference_to_alarm"),
    ...
    (3224, EvidenceStatus::Implemented, "Feature 109 CU 3224: NodeManagement audit fires for DeleteNodes/AddRef/DeleteRef (memory_mgr_impl.rs:324,409,699,878 -> audit_events.rs:24-97); test async-opcua/tests/integration/node_management.rs + async-opcua-server/src/node_manager/memory/mod.rs add_references_denies_configured_source_without_add_reference_permission_per_operation + delete_references_denies_configured_source_without_remove_reference_permission_per_operation"),
    ...
    (3539, EvidenceStatus::Implemented, "Feature 109 CU 3539: ConfigureAdmin perms defined (preset.rs:66-76); test async-opcua/tests/integration/rbac.rs secure_preset_enables_enforcement_and_grants_spec_permissions asserts all well-known role perm bits"),
    (3540, EvidenceStatus::Implemented, "Feature 109 CU 3540: AuthenticatedUser perms defined (preset.rs:34); test async-opcua/tests/integration/rbac.rs secure_preset_enables_enforcement_and_grants_spec_permissions asserts AuthenticatedUser bitset"),
    (3541, EvidenceStatus::Implemented, "Feature 109 CU 3541: Observer/Engineer/Supervisor perms defined (preset.rs:39-64); test async-opcua/tests/integration/rbac.rs secure_preset_enables_enforcement_and_grants_spec_permissions asserts all well-known role perm bits including Observer/Engineer/Supervisor"),
    ...
    (3544, EvidenceStatus::Implemented, "Feature 109 CU 3544: ResendData method (node_manager/memory/core.rs:1209-1220, subscriptions/subscription.rs:341-342,757); test async-opcua/tests/integration/methods.rs call_get_monitored_items"),
    ...
    (4466, EvidenceStatus::Implemented, "Feature 109 CU 4466: Respond2 impl dialog.rs:200-209 + methods.rs:319-336,711-714; test async-opcua/tests/integration/alarms.rs monitor_alarm_source_one_call_drives_alarm"),
    ...
    (5208, EvidenceStatus::Implemented, "Feature 109 CU 5208: IndexRange applied in monitored-item sampling (monitored_item.rs:931-940 via Variant::range_of); test async-opcua/tests/integration/write.rs write_index_range"),
