...
static AUDIT_TABLE: &[(u32, EvidenceStatus, &str)] = &[
    ...
    (2202, EvidenceStatus::Partial, "set_enabled/get_enabled (state_machine.rs:455-462) tested (alarms.rs:406,2121); no client Enable/Disable Method registered"),
    ...
    (2746, EvidenceStatus::Gap, "ExclusiveLevelAlarmType only structural (node_ids.rs:10587); LimitAlarm sets base ExclusiveLimitAlarmType(9341), not Level subtype"),
    ...
    (2893, EvidenceStatus::Gap, "no Suppress/UnSuppress MethodId registered anywhere in async-opcua-server/src/alarms/methods.rs (grep confirms)"),
    (2896, EvidenceStatus::Gap, "no SilenceState variable and no Silence method anywhere in async-opcua-server/src/alarms"),
    (2897, EvidenceStatus::Partial, "SuppressedState var+get/set_suppressed wired to SuppressedOrShelved (state_machine.rs:259-273,563-571) but 0 tests, no client Method"),
    ...
    (3001, EvidenceStatus::Gap, "NonExclusiveLevelAlarmType only structural (node_ids.rs:10591); LimitAlarm sets base NonExclusiveLimitAlarmType(9906), not Level subtype"),
    ...
    (3196, EvidenceStatus::Gap, "ServerDiagnostics (diagnostics/server.rs:10-52) only summary counts; no SamplingIntervalDiagnosticsArray, no EnabledFlag gating, no test"),
    ...
    (3763, EvidenceStatus::Gap, "explicit TODO methods.rs:201 \"Emit AuditConditionCommentEventType when audit event support is added\"; 0 AuditCondition* types used"),
    ...
    (3771, EvidenceStatus::Gap, "no OutOfService Method implemented (see 4467), so no OutOfService audit possible"),
    ...
    (3808, EvidenceStatus::Gap, "No doc artifact in docs/ or specs/ enumerating limits; limits.rs:52-151 has scattered config only, no max-secure-channels const"),
    ...
    (3911, EvidenceStatus::Partial, "Only MaxMonitoredItemsPerCall+AggregateFunctions wired to config (core.rs:858,1158; tested browse.rs:801); other Max* nodes static null."),
    (3912, EvidenceStatus::Partial, "core.rs:829-919 wires MaxArrayLength/StringLen/ByteStrLen/BrowseCP/MinSampleRate/OpLimits*; MaxSessions unwired; tests read.rs:1493"),
    ...
    (4053, EvidenceStatus::Partial, "Locations object present nodeset_16.rs:918-943, loaded via CoreNamespace core.rs:147; no test browses to it"),
    ...
    (4055, EvidenceStatus::Partial, "MaxMonitoredItemsQueueSize node null (nodeset_50.rs:3513); real limit enforced (limits.rs:126, monitored_item.rs:314) but not exposed."),
    ...
    (4428, EvidenceStatus::Gap, "depends on Silencing (2896) which is unimplemented; zero AuditConditionSilenceEventType anywhere"),
    (4463, EvidenceStatus::Gap, "no Suppress2/UnSuppress2 MethodId anywhere in async-opcua-server/src/alarms (base Suppress also absent, 2893)"),
    (4464, EvidenceStatus::Gap, "no OutOfService2 MethodId anywhere; OutOfServiceState var exists (state_machine.rs:78,275-292) but untested, no method"),
    ...
    (4467, EvidenceStatus::Partial, "OutOfServiceState var+get/set_out_of_service exist (state_machine.rs:78,117,275-292,574-582) but 0 tests, no client Method"),
    ...
    (5510, EvidenceStatus::Gap, "zero hits for \"TransitionTime\" anywhere in async-opcua-server/client/core src (grep confirmed repo-wide)"),
    (5511, EvidenceStatus::Gap, "zero hits for \"EffectiveTransitionTime\" anywhere in repo src (grep confirmed repo-wide)"),
    (5512, EvidenceStatus::Gap, "zero hits for \"EffectiveDisplayName\" anywhere in repo src (grep confirmed repo-wide)"),
    (5513, EvidenceStatus::Gap, "zero hits for \"TransitionTime\" property; ActiveState has no TransitionTime child anywhere in state_machine.rs"),
    (5514, EvidenceStatus::Gap, "zero hits for \"EffectiveTransitionTime\" property on ActiveState anywhere in repo src"),
    (5515, EvidenceStatus::Gap, "zero hits for \"EffectiveDisplayName\" property on ActiveState anywhere in repo src"),
    (5516, EvidenceStatus::Gap, "zero hits for \"TransitionTime\" property on AckedState anywhere in repo src"),
    (5517, EvidenceStatus::Gap, "zero hits for \"EffectiveTransitionTime\" property on AckedState anywhere in repo src"),
    (5518, EvidenceStatus::Gap, "zero hits for \"EffectiveDisplayName\" property on AckedState anywhere in repo src"),
    (5519, EvidenceStatus::Gap, "zero hits for \"TransitionTime\" property on ConfirmedState anywhere in repo src"),
    (5520, EvidenceStatus::Gap, "zero hits for \"EffectiveTransitionTime\" property on ConfirmedState anywhere in repo src"),
    (5521, EvidenceStatus::Gap, "zero hits for \"EffectiveDisplayName\" property on ConfirmedState anywhere in repo src"),
    (5522, EvidenceStatus::Gap, "zero hits for \"TransitionTime\" property on SuppressedState anywhere in repo src"),
    (5523, EvidenceStatus::Gap, "zero hits for \"EffectiveTransitionTime\" property on SuppressedState anywhere in repo src"),
    (5524, EvidenceStatus::Gap, "zero hits for \"EffectiveDisplayName\" property on SuppressedState anywhere in repo src"),
    (5525, EvidenceStatus::Gap, "zero hits for \"TransitionTime\" property on OutOfServiceState anywhere in repo src"),
    (5526, EvidenceStatus::Gap, "zero hits for \"EffectiveTransitionTime\" property on OutOfServiceState anywhere in repo src"),
    (5527, EvidenceStatus::Gap, "zero hits for \"EffectiveDisplayName\" property on OutOfServiceState anywhere in repo src"),
    (5528, EvidenceStatus::Gap, "no SilenceState variable exists at all (2896 also gap), so no TransitionTime property possible"),
    ...
    (5534, EvidenceStatus::Gap, "zero hits for \"TransitionTime\" on HighHighState anywhere; limit.rs non-exclusive states are plain booleans (limit.rs:891-923)"),
    (5535, EvidenceStatus::Gap, "zero hits for \"TransitionTime\" on HighState anywhere in limit.rs or repo src"),
    (5536, EvidenceStatus::Gap, "zero hits for \"TransitionTime\" on LowState anywhere in limit.rs or repo src"),
    (5537, EvidenceStatus::Gap, "zero hits for \"TransitionTime\" on LowLowState anywhere in limit.rs or repo src"),
    ...
    (5549, EvidenceStatus::Gap, "zero hits for \"LastTransition\" in any A&C code (only unrelated Programs domain hits in engine.rs/methods.rs)"),
    ...
    (5559, EvidenceStatus::Gap, "zero hits for \"LastTransition\" on LimitState anywhere in limit.rs (only current-state write_exclusive_limit_state, limit.rs:572-598)"),
